...
if __name__ == '__main__':
    ...
    # generate_by_class(class_id=9, num_images=16, epoch=10, seed=42)
    # generate_by_class(class_id=9, num_images=16, epoch=20, seed=42)
    # generate_by_class(class_id=9, num_images=16, epoch=30, seed=42) # Грузовики на 30 эпохе
    # generate_by_class(class_id=9, num_images=16, epoch=40, seed=42) # Грузовики на 40 эпохе
    generate_by_class(class_id=9, num_images=16, epoch=50, seed=42) # Грузовики на 50 эпохе 
    # pass